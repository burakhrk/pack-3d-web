...
export const scenarios: Scenario[] = [

    {
        ...
        data: {
            ...
            items: [
                ...generateItems("crate", "Industrial Crate", 14, 100, 100, 100, 150, "#4B5563"),
                ...generateItems("drum", "Oil Drum", 15, 60, 90, 60, 50, "#DC2626"),
                ...generateItems("pallet", "Pallet Stack", 10, 120, 100, 80, 200, "#F59E0B"),
                ...generateItems("long", "Long Box (200)", 10, 200, 50, 50, 80, "#2563EB"), // Blue - Long
                ...generateItems("tall", "Tall Machine (180)", 10, 60, 180, 60, 120, "#7C3AED"), // Purple - Tall
                ...generateItems("small", "Small Parts", 41, 60, 60, 60, 10, "#10B981"), // Green - Filler
            ],
